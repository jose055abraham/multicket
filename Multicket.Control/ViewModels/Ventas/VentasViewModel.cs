...
namespace Multicket.Module.ViewModels
{
	...
	public class VentasViewModel : BindableBase, INavigationAware
	{
		...
		public RelayCommand AgregarVentaCommand => new RelayCommand(action: OnAgregarVenta);
		...
		private void OnAgregarVenta(object obj)
		{
			//Producto prod = src.data.Select<Producto>((x) => x.Codigo == Codigo);
